...
<p align="right"><sub>If you'd like more details about my professional background, feel free to check out my <a href=https://github.com/markort147/markort147.github.io/blob/main/assets/cv.pdf>CV</a>.<br>
As for <a href=https://markort147.github.io/>my personal website</a>, it’s admittedly a bit outdated at the moment. I’m working on rewriting it in HTMX + Go—it’s going to be <b>amazing!<sub></b></p>
...
## a Love Declaration
<p align="right">꒰ღ˘‿˘ற꒱❤⃛</p>

Let me start with a bit about my journey: I earned an [MSc in Physics](https://www.quantumlab.it/) in 2018, during which I discovered my deep passion for learning—and my newfound love for coding.
...
[![Maven](https://img.shields.io/badge/Maven-red?logo=apache-maven)](https://github.com/search?q=user%3Amarkort147+topic%3Amaven&type=repositories)
[![Docker](https://img.shields.io/badge/Docker-blue?logo=docker)](https://github.com/search?q=user%3Amarkort147+topic%3Adocker&type=repositories)
...
[![Spring Boot](https://img.shields.io/badge/Spring%20Boot-2.5-green?logo=springboot)](https://github.com/search?q=user%3Amarkort147+topic%3Aspring-boot&type=repositories)
[![REST API](https://img.shields.io/badge/REST%20API-blue?logo=swagger)](https://github.com/search?q=user%3Amarkort147+topic%3Arest-api&type=repositories)
[![Freemarker](https://img.shields.io/badge/Freemarker-9cf?logo=apache)](https://github.com/search?q=user%3Amarkort147+topic%3Afreemarker&type=repositories)
[![MVC Architecture](https://img.shields.io/badge/MVC%20Architecture-lightgrey?logo=diagram)](https://github.com/search?q=user%3Amarkort147+topic%3Afreemarker&type=mvc-architecture)
...
A web application and REST API built with Java and Spring Boot for sharing and exploring code snippets. 🖋️ 
...
[![Skills Assessment](https://img.shields.io/badge/Skills%20Assessment-orange?logo=testing-library)](https://github.com/search?q=user%3Amarkort147+topic%3Askills-assessment&type=repositories)
[![Web Application](https://img.shields.io/badge/Web%20Application-yellow?logo=web)](https://github.com/search?q=user%3Amarkort147+topic%3Aweb-application&type=repositories)
[![Fullstack Application](https://img.shields.io/badge/Fullstack%20Application-purple?logo=stackshare)](https://github.com/search?q=user%3Amarkort147+topic%3Afullstack-application&type=repositories)
[![Spring Boot](https://img.shields.io/badge/Spring%20Boot-2.5-green?logo=springboot)](https://github.com/search?q=user%3Amarkort147+topic%3Aspring-boot&type=repositories)
...
#### [Skills-assessment project for Neural Academy course](https://github.com/markort147/Notebook_CreditRisk)
[![Python](https://img.shields.io/badge/Python-blue?logo=python&logoColor=white)](https://www.python.org/)
[![Jupyter Notebook](https://img.shields.io/badge/Jupyter%20Notebook-orange?logo=jupyter&logoColor=white)](https://jupyter.org/)
[![Libraries: NumPy](https://img.shields.io/badge/Library-NumPy-blue?logo=numpy)](https://numpy.org/)
[![Libraries: Pandas](https://img.shields.io/badge/Library-Pandas-green?logo=pandas)](https://pandas.pydata.org/)
[![Libraries: Matplotlib](https://img.shields.io/badge/Library-Matplotlib-orange?logo=plotly)](https://matplotlib.org/)
[![Libraries: Sci-Kit Learn](https://img.shields.io/badge/Library-Sci--Kit%20Learn-blue?logo=scikit-learn)](https://scikit-learn.org/)
[![Models: KNN](https://img.shields.io/badge/Model-KNN-yellow?logo=python)](https://scikit-learn.org/stable/modules/generated/sklearn.neighbors.KNeighborsClassifier.html)
[![Models: Random Forest](https://img.shields.io/badge/Model-Random%20Forest-green?logo=tree)](https://scikit-learn.org/stable/modules/generated/sklearn.ensemble.RandomForestClassifier.html)
[![Models: XGBoost](https://img.shields.io/badge/Model-XGBoost-red?logo=xgboost)](https://xgboost.readthedocs.io/)
[![Evaluation Metrics](https://img.shields.io/badge/Evaluation-Scoring%20Metrics-blue)](https://scikit-learn.org/stable/modules/model_evaluation.html)

A Jupyter notebook crafted as the grand finale for the Data Science and Machine Learning course at Neural Academy. 🎓 
It was an exciting dive into data analysis, visualization, and supervised learning techniques to evaluate credit financial risk—using this fascinating [dataset](https://www.kaggle.com/datasets/laotse/credit-risk-dataset). 📊 
A challenging yet rewarding experience that sharpened my skills and boosted my confidence in the field! 🚀  
(And yes, I know—it could use some cleanup and polish. One day I'll get to it... maybe. 😅)
...
<p align="center">
  ...
  <br>
  <img src="https://github-readme-stats.vercel.app/api?username=markort147&show_icons=true&theme=transparent&include_all_commits=true" alt="GitHub Stats" />
</p>
